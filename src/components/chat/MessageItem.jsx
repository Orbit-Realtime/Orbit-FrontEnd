  ...
  if (isMine) {
    return (
      <div className="flex justify-end items-end gap-1.5">
        ...
        <div className="max-w-[60%] bg-blue-500 rounded-2xl rounded-tr-sm px-3 py-2 text-white text-sm break-words">
          {text}
        </div>
      </div>
    );
  ...
  return (
    <div className="flex flex-col items-start">
      ...
      <div className="flex items-end gap-1.5">
        <div className="max-w-[60%] bg-neutral-700 rounded-2xl rounded-tl-sm px-3 py-2 text-white text-sm break-words">
          {text}
        </div>
