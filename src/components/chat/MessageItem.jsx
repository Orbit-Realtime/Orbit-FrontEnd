  ...
  if (isMine) {
    return (
      <div className="flex justify-end items-end gap-1.5">
        ...
        <div className="max-w-[84%] bg-orbit-surface2 rounded-xl border border-orbit-border overflow-hidden px-3 py-2 text-orbit-text text-sm">
  ...
  return (
    <div className="flex flex-col items-start">
      ...
      <div className="flex items-end gap-1.5">
        <div className="max-w-[84%] bg-orbit-surface rounded-xl border border-orbit-border overflow-hidden px-3 py-2 text-orbit-text text-sm">
          <MessageContentRenderer content={text} />
        </div>
