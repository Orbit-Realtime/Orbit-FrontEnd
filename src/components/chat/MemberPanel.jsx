...
export default function MemberPanel({ spaceId, onClose }) {
  ...
  return (
    <div className="w-60 border-l border-neutral-700 flex flex-col flex-shrink-0 bg-neutral-900">
      {/* 헤더 */}
      ...
      {showInvite ? (
            ...
            {invitableMembers.length === 0 ? (
              ...
              invitableMembers.map((member) => {
                ...
                return (
                  ...
                  >
                    <div className="w-8 h-8 rounded-full bg-neutral-600 flex items-center justify-center flex-shrink-0 text-xs font-medium text-white">
        ...
        <div className="flex flex-col flex-1 overflow-hidden">
              ...
              members.map((member) => (
                ...
                >
                  ...
                  {member.memberId === auth?.memberId && (
                    <span className="text-xs text-neutral-500 flex-shrink-0">나</span>
                  )}
                </div>
              ))
            )}
          ...
          <div className="flex-shrink-0 px-4 py-3 border-t border-neutral-700">
            <button
              onClick={openInvite}
              className="w-full py-2 bg-neutral-700 hover:bg-neutral-600 rounded-xl text-sm text-white transition-colors flex items-center justify-center gap-2"
            >
